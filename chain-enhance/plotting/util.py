...
def get_plot_filenames(root_path: Path) -> Dict[Path, List[path]]:   
    # Returns a map from dirctory to a list of all plots in the directory  
...
def find_duplicate_plot_IDs(LL_filenames=None) -> None:
