...
from chainpos import DiskProver

from chain.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR, _expected_plot_size
from chain.plotting.cache import Cache, CacheEntry
from chain.plotting.util import PlotInfo, PlotRefreshEvents, PlotRefreshResult, PlotsRefreshParameter, get_plot_filenames
...
class PlotManager:  
    ...
    def __init__(
        ...
        self.cache = Cache(self.root_path.resolve() / "cache" / "plot_manger.dat")  
