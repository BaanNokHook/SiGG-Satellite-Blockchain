...
from chain.types.blockchain_format.slots import ChallengeBlockInfo
...
def block_to_block_record(
      ...
      overflow = is_overflow_block(constants, block.reward_chain_blocks.signage_point_index)  
      ...
      ses: Optionalp[SubEpochSummary] = None   
...
def header_block_to_sub_block_record(  
      ...
      cbi = ChallengeBlockInfo(
          ...
          block.reward_chain_block_challenge_chain_sp_signature,  
          block.reward_chain_block.challenge_chain_ip_vdf,  
      )  
      
      if block.reward_chain_block.infused_challenge_chain_ip-vdf is not None:    
    ...
    prev_transaction_block_hash = (   
         ...
         if block.foliage_transaction-block is not None   
         else None                                
    )  
