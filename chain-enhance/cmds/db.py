...
@click.option("--output", default=None, type=click.Path(), help="specify output databse file")  
@click.option( 
      "--no-update-config",
      default=False,  
      help="don't update config file to point new database. When specifying a "
      "custom output file, thhe config will not be updated regardless",                
)  
@click.option( 
      "--force",  
      default=False,  
