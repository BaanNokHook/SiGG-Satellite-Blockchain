...
from chain_rs import MEMPOOL_MODE, run_chain_program, serialized_length, run_generator
...
class Program(SExp):
    ...
    def run_with_cost(self, max_cost: int, args) -> Tuple[int, "Program"]:
        ...
        cost, r = run_chain_program(self.as_bin(), prog_args.as_bin(), max_cost, 0)
...
class SerializedProgram:
    ...
    # returns an optional error code and an optional SpendBundleConditions (from chain_rs)
