...
from chain.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from chain.rpc.rpc_client import RpcClient
from chain.types.blockchain_format.sized_bytes import bytes32
from chain.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to chain RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
