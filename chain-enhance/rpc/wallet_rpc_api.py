...
from chain.consensus.block_rewards import calculate_base_farmer_reward
from chain.pools.pool_wallet import PoolWallet
from chain.pools.pool_wallet_info import FARMING_TO_POOL, PoolState, PoolWalletInfo, create_pool_state
...
from chain.rpc.rpc_server import Endpoint, EndpointResult
from chain.server.outbound_message import NodeType, make_msg
from chain.simulator.simulator_protocol import FarmNewBlockProtocol
from chain.types.announcement import Announcement
from chain.types.blockchain_format.coin import Coin, coin_as_list
...
from chain.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from chain.util.byte_types import hexstr_to_bytes
from chain.util.config import load_config
from chain.util.ints import uint8, uint32, uint64, uint16
from chain.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from chain.util.path import path_from_root
from chain.util.ws_message import WsRpcMessage, create_payload_dict
...
from chain.wallet.nft_wallet.nft_puzzles import get_metadata_and_phs
from chain.wallet.nft_wallet.nft_wallet import NFTWallet, NFTCoinInfo
...
from chain.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "chain_wallet"
    ...
    async def create_new_wallet(self, request: Dict) -> EndpointResult:
        ...
        if request["wallet_type"] == "cat_wallet":
            ...
            if request["mode"] == "new":
                ...
                from chain.pools.pool_wallet_info import initial_pool_state_from_dict
