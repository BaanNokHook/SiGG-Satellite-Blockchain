...
from chain.server.introducer_peers import VettedPeer
            ...
            try: 
                ...
                for peer in raw_peers: 
                    ...
                    try:   
                        ...
                        # if we have failed times in a row, remove the peer
                        if peer.vetted < -6:     
