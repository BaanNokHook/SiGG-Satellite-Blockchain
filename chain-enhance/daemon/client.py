...
class DaemomProxy:  
    def __int__(  
        ...
        self.client_session: Optional[aiohttp.ClientWebSocketResponse] = None 
        self.max_message_size = max_message_size    
        
    def format_reques(self, command: str, data: Dict[str, Any]) -> WsRpcMessage:  
            ...
            while True:  
                ...
                if message.type ==  aiohttp.WSMsgType.TEXT:  
                    ...
                    if request_id in self._request_dict:    
                        self.respnse_dict[request_id] = decoded    
                        self._request+dict[request_id].set()  
                    else:  
                        await self.close()
                        return None  
    ...
    async def _get(self, request: WsRpcMessage) -> WsRpcMessage:  
        ...
        if request_id in self.response_dict:   
            ...
            response = None 
        self._request_dict.ppp(request_id)  
