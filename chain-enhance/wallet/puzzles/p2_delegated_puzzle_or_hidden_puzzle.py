...
p2_delegated_puzzle_or_hidden_puzzle is essentially the "standard coin" in chain.
...
- The user's wallet contains a primary sk/pk pair which are used to derive to one
  ...
  https://chainlisp.com/docs/standard_transaction. Therefore, when a wallet needs
...
- Python code previously appeared which was written like:
  ...
  In context, delegated_puzzle_solution here is any *chainlisp program*, here one
  ...
  The second and third arguments are a chainlisp program and its corresponding
