...
from chain.consensus.block_rewards import calculate_base_farmer_reward, calculate_pool_reward
from chain.consensus.coinbase import farmer_parent_id, pool_parent_id
from chain.consensus.constants import ConsensusConstants
from chain.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH, solution_to_pool_state
from chain.pools.pool_wallet import PoolWallet
from chain.protocols import wallet_protocol
from chain.protocols.wallet_protocol import CoinState, PuzzleSolutionResponse, RespondPuzzleSolution
...
from chain.types.coin_spend import CoinSpend
...
from chain.util.byte_types import hexstr_to_bytes
from chain.util.config import process_config_start_method
from chain.util.db_synchronous import db_synchronous_on
from chain.util.db_wrapper import DBWrapper2
from chain.util.errors import Err
from chain.util.path import path_from_root
from chain.util.ints import uint8, uint32, uint64, uint128
from chain.util.lru_cache import LRUCache
from chain.wallet.cat_wallet.cat_constants import DEFAULT_CATS
from chain.wallet.cat_wallet.cat_utils import construct_cat_puzzle, match_cat_puzzle
from chain.wallet.cat_wallet.cat_wallet import CATWallet
from chain.wallet.derivation_record import DerivationRecord
from chain.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_wallet_sk_unhardened
from chain.wallet.did_wallet.did_info import DID_HRP
from chain.wallet.did_wallet.did_wallet import DIDWallet
from chain.wallet.did_wallet.did_wallet_puzzles import DID_INNERPUZ_MOD, create_fullpuz, match_did_puzzle
from chain.wallet.key_val_store import KeyValStore
from chain.wallet.nft_wallet.nft_info import NFTWalletInfo
from chain.wallet.nft_wallet.nft_puzzles import get_metadata_and_phs, get_new_owner_did
from chain.wallet.nft_wallet.nft_wallet import NFTWallet
from chain.wallet.nft_wallet.uncurry_nft import UncurriedNFT
from chain.wallet.outer_puzzles import AssetType
from chain.wallet.puzzle_drivers import PuzzleInfo
from chain.wallet.puzzles.cat_loader import CAT_MOD, CAT_MOD_HASH
from chain.wallet.rl_wallet.rl_wallet import RLWallet
from chain.wallet.settings.user_settings import UserSettings
from chain.wallet.trade_manager import TradeManager
from chain.wallet.transaction_record import TransactionRecord
from chain.wallet.util.compute_hints import compute_coin_hints
from chain.wallet.util.transaction_type import TransactionType
from chain.wallet.util.wallet_sync_utils import last_change_height_cs
from chain.wallet.util.wallet_types import WalletType
from chain.wallet.wallet import Wallet
from chain.wallet.wallet_action import WalletAction
from chain.wallet.wallet_action_store import WalletActionStore
from chain.wallet.wallet_blockchain import WalletBlockchain
from chain.wallet.wallet_coin_record import WalletCoinRecord
from chain.wallet.wallet_coin_store import WalletCoinStore
from chain.wallet.wallet_info import WalletInfo
from chain.wallet.wallet_interested_store import WalletInterestedStore
from chain.wallet.wallet_nft_store import WalletNftStore
from chain.wallet.wallet_pool_store import WalletPoolStore
from chain.wallet.wallet_puzzle_store import WalletPuzzleStore
from chain.wallet.wallet_sync_store import WalletSyncStore
from chain.wallet.wallet_transaction_store import WalletTransactionStore
from chain.wallet.wallet_user_store import WalletUserStore
from chain.wallet.wallet_weight_proof_handler import WalletWeightProofHandler
...
class WalletStateManager:
    ...
    async def determine_coin_type(
        self, peer: WSchainConnection, coin_state: CoinState, fork_height: Optional[uint32]
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSchainConnection, fork_height: Optional[uint32]
    ) -> None:
