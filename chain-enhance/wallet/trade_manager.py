...
from chain.wallet.trading.offer import NotarizedPayment, Offer
from chain.wallet.trading.trade_status import TradeStatus
from chain.wallet.trading.trade_store import TradeStore
...
class TradeManager:
    ...
    Puzzle Drivers:
      - See chain/wallet/outer_puzzles.py for a full description of how to build these
