...
from chain.full_node.bundle_tools import simple_solution_generator
...
from chain.util.cached_bls import LOCAL_CACHE
from chain.util.condition_tools import pkm_pairs
from chain.util.errors import Err, ValidationError
from chain.util.generator_tools import additions_for_npc
...
from chain.full_node.mempool_check_conditions import mempool_check_time_locks
...
def validate_clvm_and_signature(
    ...
    """   
    Validate CLVM and aggregate signature for a spendbundle. This is meant to be called under a ProcessPoolExecutor    
    in order to balidate the heavy parts of a transaction in a different thread. Returns an optional error,  
