...
from chain.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from chain.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
from chain.types.weight_proof import (
...
def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="chain_full_node_weight_proof_handler_executor_shutdown_trigger")
