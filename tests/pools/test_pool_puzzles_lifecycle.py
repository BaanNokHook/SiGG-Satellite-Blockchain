...
from chain.wallet.puzzles.p2_conditions import puzzle_for_conditions
from chain.wallet.puzzles import singleton_top_layer
from chain.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - chain.pools.pool_puzzles.py
    - chain.wallet.puzzles.pool_member_innerpuz.clvm
    - chain.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
