...
from chain.pools.pool_config import PoolWalletConfig
from chain.util.config import create_default_chain_config, load_config, lock_config, save_config
...
def test_pool_config(tmp_path):
    ...
    create_default_chain_config(test_root, ["config.yaml"])
