...
from chain.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "chain/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "chain/wallet/puzzles/cat.clvm",
        "chain/wallet/puzzles/chainlisp_deserialisation.clvm",
        "chain/wallet/puzzles/rom_bootstrap_generator.clvm",
        "chain/wallet/puzzles/generator_for_single_coin.clvm",
        "chain/wallet/puzzles/lock.inner.puzzle.clvm",
        "chain/wallet/puzzles/p2_conditions.clvm",
        "chain/wallet/puzzles/p2_delegated_conditions.clvm",
        "chain/wallet/puzzles/p2_delegated_puzzle.clvm",
        "chain/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "chain/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "chain/wallet/puzzles/p2_puzzle_hash.clvm",
        "chain/wallet/puzzles/rl_aggregation.clvm",
        "chain/wallet/puzzles/rl.clvm",
        "chain/wallet/puzzles/sha256tree_module.clvm",
        "chain/wallet/puzzles/singleton_top_layer.clvm",
        "chain/wallet/puzzles/did_innerpuz.clvm",
        "chain/wallet/puzzles/decompress_puzzle.clvm",
        "chain/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "chain/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "chain/wallet/puzzles/block_program_zero.clvm",
        "chain/wallet/puzzles/test_generator_deserialize.clvm",
        "chain/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "chain/wallet/puzzles/p2_singleton.clvm",
        "chain/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "chain/wallet/puzzles/pool_member_innerpuz.clvm",
        "chain/wallet/puzzles/singleton_launcher.clvm",
        "chain/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
        "chain/wallet/puzzles/genesis_by_puzzle_hash.clvm",
        "chain/wallet/puzzles/everything_with_signature.clvm",
        "chain/wallet/puzzles/delegated_tail.clvm",
        "chain/wallet/puzzles/settlement_payments.clvm",
        "chain/wallet/puzzles/genesis_by_coin_id.clvm",
        "chain/wallet/puzzles/singleton_top_layer_v1_1.clvm",
        "chain/wallet/puzzles/nft_metadata_updater_default.clvm",
        "chain/wallet/puzzles/nft_metadata_updater_updateable.clvm",
        "chain/wallet/puzzles/nft_state_layer.clvm",
        "chain/wallet/puzzles/nft_ownership_layer.clvm",
        "chain/wallet/puzzles/nft_ownership_transfer_program_one_way_claim_with_royalties.clvm",
    ]
)

clvm_include_files = set(
    ["chain/wallet/puzzles/create-lock-puzzlehash.clvm", "chain/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "chain/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to chain/wallet/puzzles, but not added to `wallet_program_files`
        """
