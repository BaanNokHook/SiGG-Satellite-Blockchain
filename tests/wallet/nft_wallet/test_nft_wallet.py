...
async def test_nft_wallet_creation_automatically(two_wallet_nodes: Any, trusted: Any) -> None:
    ...
    metadata = Program.to(
        [
            ("u", ["https://www.chain.net/img/branding/chain-logo.svg"]),
...
async def test_nft_wallet_rpc_creation_and_list(two_wallet_nodes: Any, trusted: Any) -> None:
    ...
    tr1 = await api_0.nft_mint_nft(
        {
            ...
            "uris": ["https://www.chain.net/img/branding/chain-logo.svg"],
        }
    )
    ...
    tr2 = await api_0.nft_mint_nft(
        {
            ...
            "uris": ["https://chainlisp.com/img/logo.svg"],
        }
    )
    ...
    assert len(uris) == 2
    assert "https://chainlisp.com/img/logo.svg" in uris
...
async def test_nft_wallet_rpc_update_metadata(two_wallet_nodes: Any, trusted: Any) -> None:
    ...
    uris = coin["data_uris"]
    assert len(uris) == 1
    assert "https://www.chain.net/img/branding/chain-logo.svg" in uris
...
async def test_nft_with_did_wallet_creation(two_wallet_nodes: Any, trusted: Any) -> None:
    ...
    assert did_nft["data_uris"][0] == "https://www.chain.net/img/branding/chain-logo.svg"
    ...
    resp = await api_0.nft_mint_nft(
        {
            ...
            "hash": "0xD4584AD463139FA8C0D9F68F4B59F185",
            "uris": ["https://www.chain.net/img/branding/chain-logo.svg"],
            "mu": ["https://www.chain.net/img/branding/chain-logo.svg"],
        }
    )
    assert resp.get("success")
    sb = resp["spend_bundle"]
