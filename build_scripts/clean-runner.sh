...
rm -rf ../venv || true
rm -rf venv || true
rm -rf chain_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf chain-blockchain-gui/build || true
rm -rf chain-blockchain-gui/daemon || true
rm -rf chain-blockchain-gui/node_modules || true
rm chain-blockchain-gui/temp.json || true
( cd "$PWD/chain-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
