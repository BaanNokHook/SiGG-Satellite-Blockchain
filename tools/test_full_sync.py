...
from chain.cmds.init_funcs import chain_init
...
async def run_sync_test(
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        chain_init(root_path, should_check_keys=False, v1_db=(db_version == 1))
        ...
        try:
            ...
            peer: ws.WSchainConnection = FakePeer()  # type: ignore[assignment]
...
async def run_sync_checkpoint(
    ...
    chain_init(root_path, should_check_keys=False, v1_db=False)
    config = load_config(root_path, "config.yaml")
